      ...
      <div className="w-full h-full flex flex-row justify-start items-start p-3 md:p-5 gap-5">
        ...
        <main className="w-full p-5 md:p-8">
          ...
          <form
            ...
            className="w-full flex flex-col gap-5 bg-violet-50 rounded-2xl shadow-lg p-5 md:p-8"
          >
            <div className="mb-8">
              ...
              <p className="text-sm md:text-base text-violet-700 mt-1">
                Você pode cadastrar categorias personalizadas para detalhar seus
                recebimentos ou despesas recorrentes do dia a dia.
              </p>
            </div>
